...
var DracoDecoderModule = function(t) {
    ...
    if ((e || (e = i), (r = ""), 128 > n)) {
      for (; 0 < e; )
        (n = String.fromCharCode.apply(
          String,
          Z.subarray(t, t + Math.min(e, 1024))
        )),
          (r = r ? r + n : n),
          (t += 1024),
          (e -= 1024);
  ...
  function o(t, e) {
    for (var r = e; t[r]; ) ++r;
    if (16 < r - e && t.subarray && at) return at.decode(t.subarray(e, r));
    for (r = ""; ; ) {
      var n = t[e++];
      if (!n) return r;
      if (128 & n) {
        var o = 63 & t[e++];
        if (192 == (224 & n)) r += String.fromCharCode(((31 & n) << 6) | o);
        else {
          var i = 63 & t[e++];
          if (224 == (240 & n)) n = ((15 & n) << 12) | (o << 6) | i;
          else {
            var _ = 63 & t[e++];
            if (240 == (248 & n))
              n = ((7 & n) << 18) | (o << 12) | (i << 6) | _;
  ...
  function _() {
    (L.HEAP8 = K = new Int8Array(ft)),
      (L.HEAP16 = J = new Int16Array(ft)),
      (L.HEAP32 = tt = new Int32Array(ft)),
      (L.HEAPU8 = Z = new Uint8Array(ft)),
      (L.HEAPU16 = new Uint16Array(ft)),
      (L.HEAPU32 = new Uint32Array(ft)),
      (L.HEAPF32 = new Float32Array(ft)),
      (L.HEAPF64 = new Float64Array(ft));
  }
  function p(t) {
    for (; 0 < t.length; ) {
      var e = t.shift();
  ...
  function c() {
    var t = jt.last;
    if (!t) return 0 | (Kr(0), 0);
    var e = jt.infos[t],
      r = e.type;
    if (!r) return 0 | (Kr(0), t);
    var n = Array.prototype.slice.call(arguments);
    L.___cxa_is_pointer_type(r),
      c.buffer || (c.buffer = Xr(4)),
      (tt[c.buffer >> 2] = t),
      (t = c.buffer);
    for (var o = 0; o < n.length; o++)
      if (n[o] && L.___cxa_can_catch(n[o], r, t))
        return (t = tt[t >> 2]), (e.adjusted = t), 0 | (Kr(n[o]), t);
    return (t = tt[t >> 2]), 0 | (Kr(r), t);
  }
  function s(t, e) {
    gt.varargs = e;
    try {
      ...
      for (
        t = 0,
          s.buffers ||
            ((s.buffers = [null, [], []]),
            (s.printChar = function(t, e) {
              var n = s.buffers[t];
              r(n),
                0 === e || 10 === e
                  ? ((1 === t ? L.print : L.printErr)(o(n, 0)), (n.length = 0))
                  : n.push(e);
            })),
          e = 0;
        e < _;
        ...
        for (
          var p = tt[(i + 8 * e) >> 2], a = tt[(i + (8 * e + 4)) >> 2], u = 0;
          u < a;
          u++
        )
          s.printChar(n, Z[p + u]);
      ...
      return (
        ("undefined" != typeof FS && t instanceof FS.ErrnoError) || m(t),
        -t.errno
      );
    }
  }
  ...
  function f(t) {
    function e() {
      if (!L.calledRun && ((L.calledRun = !0), !pt)) {
        if (
          (Tt || ((Tt = !0), p(dt)),
          p(bt),
  ...
  function m(t) {
    throw (L.onAbort && L.onAbort(t),
    void 0 !== t
      ? (L.print(t), L.printErr(t), (t = JSON.stringify(t)))
      : (t = ""),
    (pt = !0),
  ...
  function j() {
    (this.ptr = Mt()), (b(j)[this.ptr] = this);
  }
  function g() {
    (this.ptr = sr()), (b(g)[this.ptr] = this);
  }
  function S() {
    (this.ptr = Lt()), (b(S)[this.ptr] = this);
  }
  function R() {
    (this.ptr = Ct()), (b(R)[this.ptr] = this);
  }
  function G() {
    (this.ptr = Re()), (b(G)[this.ptr] = this);
  }
  function M() {
    (this.ptr = ir()), (b(M)[this.ptr] = this);
  }
  function O() {
    (this.ptr = Te()), (b(O)[this.ptr] = this);
  }
  function w() {
    (this.ptr = de()), (b(w)[this.ptr] = this);
  }
  function P() {
    (this.ptr = $e()), (b(P)[this.ptr] = this);
  }
  function C() {
    (this.ptr = Vt()), (b(C)[this.ptr] = this);
  }
  function N() {
    (this.ptr = qt()), (b(N)[this.ptr] = this);
  }
  function F() {
    (this.ptr = He()), (b(F)[this.ptr] = this);
  }
  function U() {
  ...
  (L.onRuntimeInitialized = function() {
    ...
    (L.onModuleParsed = function() {
      (k = !0),
        x && "function" == typeof L.onModuleLoaded && L.onModuleLoaded(L);
    }),
  ...
  var V,
    $ = {};
  for (V in L) L.hasOwnProperty(V) && ($[V] = L[V]);
  (L.arguments = []),
    (L.thisProgram = "./this.program"),
    (L.quit = function(t, e) {
      throw e;
    }),
    (L.preRun = []),
  ...
  var Q,
    ...
    X = !1;
  if (L.ENVIRONMENT)
    if ("WEB" === L.ENVIRONMENT) W = !0;
    else if ("WORKER" === L.ENVIRONMENT) q = !0;
    else if ("NODE" === L.ENVIRONMENT) Y = !0;
    else {
      if ("SHELL" !== L.ENVIRONMENT)
        throw Error(
    ...
    (W = "object" == typeof window),
      ...
      (Y =
        "object" == typeof process && "function" == typeof require && !W && !q),
      (X = !W && !Y && !q);
  Y
    ? ((L.read = function(t, e) {
        return (
      ...
      (L.readBinary = function(t) {
        return (
          (t = L.read(t, !0)).buffer || (t = new Uint8Array(t)), r(t.buffer), t
        );
      }),
    ...
    ? ("undefined" != typeof read &&
      ...
      "undefined" != typeof scriptArgs
        ? (L.arguments = scriptArgs)
        : void 0 !== arguments && (L.arguments = arguments),
  ...
  (L.printErr =
    "undefined" != typeof printErr
      ...
      : ("undefined" != typeof console && console.warn.bind(console)) ||
        L.print),
  (L.print = L.print),
  (L.printErr = L.printErr),
  $))
    $.hasOwnProperty(V) && (L[V] = $[V]);
  $ = void 0;
  var K,
    Z,
    J,
  ...
  var ut = (et = rt = nt = ot = it = _t = 0),
    ct = !1;
  L.reallocBuffer ||
    (L.reallocBuffer = function(t) {
      try {
        if (ArrayBuffer.transfer) var e = ArrayBuffer.transfer(ft, t);
        else {
          var r = K;
  ...
  try {
    var st = Function.prototype.call.bind(
  ...
  var lt = L.TOTAL_STACK || 5242880,
    yt = L.TOTAL_MEMORY || 16777216;
  if (
    (yt < lt &&
      L.printErr(
    ...
    "object" == typeof WebAssembly && "function" == typeof WebAssembly.Memory
      ? ((L.wasmMemory = new WebAssembly.Memory({ initial: yt / 65536 })),
        (ft = L.wasmMemory.buffer))
      : (ft = new ArrayBuffer(yt)),
      (L.buffer = ft);
  if ((_(), (tt[0] = 1668509029), (J[1] = 25459), 115 !== Z[2] || 99 !== Z[3]))
  ...
  (L.preloadedImages = {}),
    ...
    (function() {
      ...
      function e() {
        return L.wasmBinary || (!W && !q) || "function" != typeof fetch
      ...
      function r(t, r, n) {
        function i(t, e) {
          (c = t.exports).memory &&
            ...
            (e = new Int8Array(e)),
            new Int8Array(t).set(e),
            (L.buffer = ft = t),
            _()),
            (L.asm = c),
            (L.usingWasm = !0),
            It--,
            L.monitorRunDependencies && L.monitorRunDependencies(It),
            0 == It &&
              (null !== vt && (clearInterval(vt), (vt = null)),
              Et && ((t = Et), (Et = null), t()));
        }
        function p(t) {
        ...
        if ("object" != typeof WebAssembly)
          return L.printErr("no native wasm support detected"), !1;
        if (!(L.wasmMemory instanceof WebAssembly.Memory))
          return L.printErr("no native wasm Memory in use"), !1;
        if (
          ((r.memory = L.wasmMemory),
          (u.global = { NaN: NaN, Infinity: 1 / 0 }),
          (u["global.Math"] = Math),
          (u.env = r),
          It++,
          L.monitorRunDependencies && L.monitorRunDependencies(It),
        ...
        return (
          ...
          "function" != typeof fetch
            ...
            : WebAssembly.instantiateStreaming(
                ...
                .then(p)
                .catch(function(t) {
                  L.printErr("wasm streaming compile failed: " + t),
                    L.printErr("falling back to ArrayBuffer instantiation"),
                    s(p);
                }),
          {}
        );
      }
      var n = "draco_decoder.wast",
        o = "draco_decoder.wasm",
        p = "draco_decoder.temp.asm.js";
      "function" == typeof L.locateFile &&
        (a(n) || (n = L.locateFile(n)),
        a(o) || (o = L.locateFile(o)),
        a(p) || (p = L.locateFile(p)));
      var u = {
          global: null,
          env: null,
          asm2wasm: {
        ...
        if ("asmjs" === l) var e = s(t);
          ...
          t: {
            ...
            if (L.usingWasm)
              try {
                e =
                  -1 !== L.wasmMemory.grow((t - r) / 65536)
                    ? (L.buffer = L.wasmMemory.buffer)
                    : null;
                break t;
              } catch (t) {
                e = null;
      ...
      L.asm = function(t, e, n) {
        ...
        return (
          e.memoryBase || (e.memoryBase = L.STATIC_BASE),
  ...
  var jt = {
      ...
      infos: {},
      deAdjust: function(t) {
        if (!t || jt.infos[t]) return t;
        for (var e in jt.infos) if (jt.infos[e].adjusted === t) return e;
        return t;
      },
      addRef: function(t) {
        t && jt.infos[t].refcount++;
      },
      decRef: function(t) {
        if (t) {
          var e = jt.infos[t];
          r(0 < e.refcount),
            ...
            0 !== e.refcount ||
              e.rethrown ||
              (e.destructor && L.dynCall_vi(e.destructor, t),
              delete jt.infos[t],
              ___cxa_free_exception(t));
        }
      },
      clearRef: function(t) {
        t && (jt.infos[t].refcount = 0);
      },
    },
    gt = {
      varargs: 0,
      get: function(t) {
        return (gt.varargs += 4), tt[(gt.varargs - 4) >> 2];
      },
      getStr: function() {
        return n(gt.get());
      },
  ...
  (_t = (function(t) {
    ...
    (ct = !0),
    (L.wasmTableSize = 468),
    (L.wasmMaxTableSize = 468),
    (L.asmGlobalArg = {}),
    (L.asmLibraryArg = {
      abort: m,
      assert: r,
      enlargeMemory: function() {
        var t = L.usingWasm ? 65536 : 16777216,
          e = 2147483648 - t;
        if (tt[_t >> 2] > e) return !1;
        var r = yt;
        for (yt = Math.max(yt, 16777216); yt < tt[_t >> 2]; )
          yt =
            536870912 >= yt
              ? i(2 * yt, t)
              : Math.min(i((3 * yt + 2147483648) / 4, t), e);
        return (t = L.reallocBuffer(yt)) && t.byteLength == yt
          ? ((L.buffer = ft = t), _(), !0)
          : ((yt = r), !1);
      },
      ...
      ___cxa_begin_catch: function(t) {
        var e = jt.infos[t];
        return (
          e && !e.caught && ((e.caught = !0), u.uncaught_exception--),
          e && (e.rethrown = !1),
          jt.caught.push(t),
          jt.addRef(jt.deAdjust(t)),
          t
        );
      },
      ___cxa_find_matching_catch: c,
      ___cxa_pure_virtual: function() {
        throw ((pt = !0), "Pure virtual function called!");
      },
      ...
      _emscripten_memcpy_big: function(t, e, r) {
        return Z.set(Z.subarray(e, e + r), t), t;
      },
      _llvm_trap: function() {
        m("trap!");
      },
      ...
      _pthread_key_create: function(t, e) {
        return 0 == t ? 22 : ((tt[t >> 2] = Rt), (St[Rt] = 0), Rt++, 0);
      },
      _pthread_once: l,
      _pthread_setspecific: function(t, e) {
        return t in St ? ((St[t] = e), 0) : 22;
      },
  ...
  var Gt = L.asm(L.asmGlobalArg, L.asmLibraryArg, ft);
  (L.asm = Gt),
    (L.___cxa_can_catch = function() {
  ...
  var Mt = (L._emscripten_bind_AttributeOctahedronTransform_AttributeOctahedronTransform_0 = function() {
      return L.asm._emscripten_bind_AttributeOctahedronTransform_AttributeOctahedronTransform_0.apply(
        null,
        arguments
      );
    }),
    Ot = (L._emscripten_bind_AttributeOctahedronTransform_InitFromAttribute_1 = function() {
      return L.asm._emscripten_bind_AttributeOctahedronTransform_InitFromAttribute_1.apply(
        null,
        arguments
      );
    }),
    wt = (L._emscripten_bind_AttributeOctahedronTransform___destroy___0 = function() {
      return L.asm._emscripten_bind_AttributeOctahedronTransform___destroy___0.apply(
        null,
        arguments
      );
    }),
    Pt = (L._emscripten_bind_AttributeOctahedronTransform_quantization_bits_0 = function() {
      return L.asm._emscripten_bind_AttributeOctahedronTransform_quantization_bits_0.apply(
        null,
        arguments
      );
    }),
    Ct = (L._emscripten_bind_AttributeQuantizationTransform_AttributeQuantizationTransform_0 = function() {
      return L.asm._emscripten_bind_AttributeQuantizationTransform_AttributeQuantizationTransform_0.apply(
        null,
        arguments
      );
    }),
    Nt = (L._emscripten_bind_AttributeQuantizationTransform_InitFromAttribute_1 = function() {
      return L.asm._emscripten_bind_AttributeQuantizationTransform_InitFromAttribute_1.apply(
        null,
        arguments
      );
    }),
    Ft = (L._emscripten_bind_AttributeQuantizationTransform___destroy___0 = function() {
      return L.asm._emscripten_bind_AttributeQuantizationTransform___destroy___0.apply(
        null,
        arguments
      );
    }),
    Ut = (L._emscripten_bind_AttributeQuantizationTransform_min_value_1 = function() {
      return L.asm._emscripten_bind_AttributeQuantizationTransform_min_value_1.apply(
        null,
        arguments
      );
    }),
    Bt = (L._emscripten_bind_AttributeQuantizationTransform_quantization_bits_0 = function() {
      return L.asm._emscripten_bind_AttributeQuantizationTransform_quantization_bits_0.apply(
        null,
        arguments
      );
    }),
    zt = (L._emscripten_bind_AttributeQuantizationTransform_range_0 = function() {
      return L.asm._emscripten_bind_AttributeQuantizationTransform_range_0.apply(
        null,
        arguments
      );
    }),
    Lt = (L._emscripten_bind_AttributeTransformData_AttributeTransformData_0 = function() {
      return L.asm._emscripten_bind_AttributeTransformData_AttributeTransformData_0.apply(
        null,
        arguments
      );
    }),
    xt = (L._emscripten_bind_AttributeTransformData___destroy___0 = function() {
      return L.asm._emscripten_bind_AttributeTransformData___destroy___0.apply(
        null,
        arguments
      );
    }),
    kt = (L._emscripten_bind_AttributeTransformData_transform_type_0 = function() {
      return L.asm._emscripten_bind_AttributeTransformData_transform_type_0.apply(
        null,
        arguments
      );
    }),
    Vt = (L._emscripten_bind_DecoderBuffer_DecoderBuffer_0 = function() {
      return L.asm._emscripten_bind_DecoderBuffer_DecoderBuffer_0.apply(
        null,
        arguments
      );
    }),
    $t = (L._emscripten_bind_DecoderBuffer_Init_2 = function() {
      return L.asm._emscripten_bind_DecoderBuffer_Init_2.apply(null, arguments);
    }),
    Qt = (L._emscripten_bind_DecoderBuffer___destroy___0 = function() {
      return L.asm._emscripten_bind_DecoderBuffer___destroy___0.apply(
        null,
        arguments
      );
    }),
    Ht = (L._emscripten_bind_Decoder_DecodeBufferToMesh_2 = function() {
      return L.asm._emscripten_bind_Decoder_DecodeBufferToMesh_2.apply(
        null,
        arguments
      );
    }),
    Wt = (L._emscripten_bind_Decoder_DecodeBufferToPointCloud_2 = function() {
      return L.asm._emscripten_bind_Decoder_DecodeBufferToPointCloud_2.apply(
        null,
        arguments
      );
    }),
    qt = (L._emscripten_bind_Decoder_Decoder_0 = function() {
      return L.asm._emscripten_bind_Decoder_Decoder_0.apply(null, arguments);
    }),
    Yt = (L._emscripten_bind_Decoder_GetAttributeByUniqueId_2 = function() {
      return L.asm._emscripten_bind_Decoder_GetAttributeByUniqueId_2.apply(
        null,
        arguments
      );
    }),
    Xt = (L._emscripten_bind_Decoder_GetAttributeFloatForAllPoints_3 = function() {
      return L.asm._emscripten_bind_Decoder_GetAttributeFloatForAllPoints_3.apply(
        null,
        arguments
      );
    }),
    Kt = (L._emscripten_bind_Decoder_GetAttributeFloat_3 = function() {
      return L.asm._emscripten_bind_Decoder_GetAttributeFloat_3.apply(
        null,
        arguments
      );
    }),
    Zt = (L._emscripten_bind_Decoder_GetAttributeIdByMetadataEntry_3 = function() {
      return L.asm._emscripten_bind_Decoder_GetAttributeIdByMetadataEntry_3.apply(
        null,
        arguments
      );
    }),
    Jt = (L._emscripten_bind_Decoder_GetAttributeIdByName_2 = function() {
      return L.asm._emscripten_bind_Decoder_GetAttributeIdByName_2.apply(
        null,
        arguments
      );
    }),
    te = (L._emscripten_bind_Decoder_GetAttributeId_2 = function() {
      return L.asm._emscripten_bind_Decoder_GetAttributeId_2.apply(
        null,
        arguments
      );
    }),
    ee = (L._emscripten_bind_Decoder_GetAttributeInt16ForAllPoints_3 = function() {
      return L.asm._emscripten_bind_Decoder_GetAttributeInt16ForAllPoints_3.apply(
        null,
        arguments
      );
    }),
    re = (L._emscripten_bind_Decoder_GetAttributeInt32ForAllPoints_3 = function() {
      return L.asm._emscripten_bind_Decoder_GetAttributeInt32ForAllPoints_3.apply(
        null,
        arguments
      );
    }),
    ne = (L._emscripten_bind_Decoder_GetAttributeInt8ForAllPoints_3 = function() {
      return L.asm._emscripten_bind_Decoder_GetAttributeInt8ForAllPoints_3.apply(
        null,
        arguments
      );
    }),
    oe = (L._emscripten_bind_Decoder_GetAttributeIntForAllPoints_3 = function() {
      return L.asm._emscripten_bind_Decoder_GetAttributeIntForAllPoints_3.apply(
        null,
        arguments
      );
    }),
    ie = (L._emscripten_bind_Decoder_GetAttributeMetadata_2 = function() {
      return L.asm._emscripten_bind_Decoder_GetAttributeMetadata_2.apply(
        null,
        arguments
      );
    }),
    _e = (L._emscripten_bind_Decoder_GetAttributeUInt16ForAllPoints_3 = function() {
      return L.asm._emscripten_bind_Decoder_GetAttributeUInt16ForAllPoints_3.apply(
        null,
        arguments
      );
    }),
    pe = (L._emscripten_bind_Decoder_GetAttributeUInt32ForAllPoints_3 = function() {
      return L.asm._emscripten_bind_Decoder_GetAttributeUInt32ForAllPoints_3.apply(
        null,
        arguments
      );
    }),
    ae = (L._emscripten_bind_Decoder_GetAttributeUInt8ForAllPoints_3 = function() {
      return L.asm._emscripten_bind_Decoder_GetAttributeUInt8ForAllPoints_3.apply(
        null,
        arguments
      );
    }),
    ue = (L._emscripten_bind_Decoder_GetAttribute_2 = function() {
      return L.asm._emscripten_bind_Decoder_GetAttribute_2.apply(
        null,
        arguments
      );
    }),
    ce = (L._emscripten_bind_Decoder_GetEncodedGeometryType_1 = function() {
      return L.asm._emscripten_bind_Decoder_GetEncodedGeometryType_1.apply(
        null,
        arguments
      );
    }),
    se = (L._emscripten_bind_Decoder_GetFaceFromMesh_3 = function() {
      return L.asm._emscripten_bind_Decoder_GetFaceFromMesh_3.apply(
        null,
        arguments
      );
    }),
    le = (L._emscripten_bind_Decoder_GetMetadata_1 = function() {
      return L.asm._emscripten_bind_Decoder_GetMetadata_1.apply(
        null,
        arguments
      );
    }),
    ye = (L._emscripten_bind_Decoder_GetTriangleStripsFromMesh_2 = function() {
      return L.asm._emscripten_bind_Decoder_GetTriangleStripsFromMesh_2.apply(
        null,
        arguments
      );
    }),
    fe = (L._emscripten_bind_Decoder_SkipAttributeTransform_1 = function() {
      return L.asm._emscripten_bind_Decoder_SkipAttributeTransform_1.apply(
        null,
        arguments
      );
    }),
    me = (L._emscripten_bind_Decoder___destroy___0 = function() {
      return L.asm._emscripten_bind_Decoder___destroy___0.apply(
        null,
        arguments
      );
    }),
    de = (L._emscripten_bind_DracoFloat32Array_DracoFloat32Array_0 = function() {
      return L.asm._emscripten_bind_DracoFloat32Array_DracoFloat32Array_0.apply(
        null,
        arguments
      );
    }),
    be = (L._emscripten_bind_DracoFloat32Array_GetValue_1 = function() {
      return L.asm._emscripten_bind_DracoFloat32Array_GetValue_1.apply(
        null,
        arguments
      );
    }),
    he = (L._emscripten_bind_DracoFloat32Array___destroy___0 = function() {
      return L.asm._emscripten_bind_DracoFloat32Array___destroy___0.apply(
        null,
        arguments
      );
    }),
    Ae = (L._emscripten_bind_DracoFloat32Array_size_0 = function() {
      return L.asm._emscripten_bind_DracoFloat32Array_size_0.apply(
        null,
        arguments
      );
    }),
    Te = (L._emscripten_bind_DracoInt16Array_DracoInt16Array_0 = function() {
      return L.asm._emscripten_bind_DracoInt16Array_DracoInt16Array_0.apply(
        null,
        arguments
      );
    }),
    Ie = (L._emscripten_bind_DracoInt16Array_GetValue_1 = function() {
      return L.asm._emscripten_bind_DracoInt16Array_GetValue_1.apply(
        null,
        arguments
      );
    }),
    ve = (L._emscripten_bind_DracoInt16Array___destroy___0 = function() {
      return L.asm._emscripten_bind_DracoInt16Array___destroy___0.apply(
        null,
        arguments
      );
    }),
    Ee = (L._emscripten_bind_DracoInt16Array_size_0 = function() {
      return L.asm._emscripten_bind_DracoInt16Array_size_0.apply(
        null,
        arguments
      );
    }),
    De = (L._emscripten_bind_DracoInt32Array_DracoInt32Array_0 = function() {
      return L.asm._emscripten_bind_DracoInt32Array_DracoInt32Array_0.apply(
        null,
        arguments
      );
    }),
    je = (L._emscripten_bind_DracoInt32Array_GetValue_1 = function() {
      return L.asm._emscripten_bind_DracoInt32Array_GetValue_1.apply(
        null,
        arguments
      );
    }),
    ge = (L._emscripten_bind_DracoInt32Array___destroy___0 = function() {
      return L.asm._emscripten_bind_DracoInt32Array___destroy___0.apply(
        null,
        arguments
      );
    }),
    Se = (L._emscripten_bind_DracoInt32Array_size_0 = function() {
      return L.asm._emscripten_bind_DracoInt32Array_size_0.apply(
        null,
        arguments
      );
    }),
    Re = (L._emscripten_bind_DracoInt8Array_DracoInt8Array_0 = function() {
      return L.asm._emscripten_bind_DracoInt8Array_DracoInt8Array_0.apply(
        null,
        arguments
      );
    }),
    Ge = (L._emscripten_bind_DracoInt8Array_GetValue_1 = function() {
      return L.asm._emscripten_bind_DracoInt8Array_GetValue_1.apply(
        null,
        arguments
      );
    }),
    Me = (L._emscripten_bind_DracoInt8Array___destroy___0 = function() {
      return L.asm._emscripten_bind_DracoInt8Array___destroy___0.apply(
        null,
        arguments
      );
    }),
    Oe = (L._emscripten_bind_DracoInt8Array_size_0 = function() {
      return L.asm._emscripten_bind_DracoInt8Array_size_0.apply(
        null,
        arguments
      );
    }),
    we = (L._emscripten_bind_DracoUInt16Array_DracoUInt16Array_0 = function() {
      return L.asm._emscripten_bind_DracoUInt16Array_DracoUInt16Array_0.apply(
        null,
        arguments
      );
    }),
    Pe = (L._emscripten_bind_DracoUInt16Array_GetValue_1 = function() {
      return L.asm._emscripten_bind_DracoUInt16Array_GetValue_1.apply(
        null,
        arguments
      );
    }),
    Ce = (L._emscripten_bind_DracoUInt16Array___destroy___0 = function() {
      return L.asm._emscripten_bind_DracoUInt16Array___destroy___0.apply(
        null,
        arguments
      );
    }),
    Ne = (L._emscripten_bind_DracoUInt16Array_size_0 = function() {
      return L.asm._emscripten_bind_DracoUInt16Array_size_0.apply(
        null,
        arguments
      );
    }),
    Fe = (L._emscripten_bind_DracoUInt32Array_DracoUInt32Array_0 = function() {
      return L.asm._emscripten_bind_DracoUInt32Array_DracoUInt32Array_0.apply(
        null,
        arguments
      );
    }),
    Ue = (L._emscripten_bind_DracoUInt32Array_GetValue_1 = function() {
      return L.asm._emscripten_bind_DracoUInt32Array_GetValue_1.apply(
        null,
        arguments
      );
    }),
    Be = (L._emscripten_bind_DracoUInt32Array___destroy___0 = function() {
      return L.asm._emscripten_bind_DracoUInt32Array___destroy___0.apply(
        null,
        arguments
      );
    }),
    ze = (L._emscripten_bind_DracoUInt32Array_size_0 = function() {
      return L.asm._emscripten_bind_DracoUInt32Array_size_0.apply(
        null,
        arguments
      );
    }),
    Le = (L._emscripten_bind_DracoUInt8Array_DracoUInt8Array_0 = function() {
      return L.asm._emscripten_bind_DracoUInt8Array_DracoUInt8Array_0.apply(
        null,
        arguments
      );
    }),
    xe = (L._emscripten_bind_DracoUInt8Array_GetValue_1 = function() {
      return L.asm._emscripten_bind_DracoUInt8Array_GetValue_1.apply(
        null,
        arguments
      );
    }),
    ke = (L._emscripten_bind_DracoUInt8Array___destroy___0 = function() {
      return L.asm._emscripten_bind_DracoUInt8Array___destroy___0.apply(
        null,
        arguments
      );
    }),
    Ve = (L._emscripten_bind_DracoUInt8Array_size_0 = function() {
      return L.asm._emscripten_bind_DracoUInt8Array_size_0.apply(
        null,
        arguments
      );
    }),
    $e = (L._emscripten_bind_GeometryAttribute_GeometryAttribute_0 = function() {
      return L.asm._emscripten_bind_GeometryAttribute_GeometryAttribute_0.apply(
        null,
        arguments
      );
    }),
    Qe = (L._emscripten_bind_GeometryAttribute___destroy___0 = function() {
      return L.asm._emscripten_bind_GeometryAttribute___destroy___0.apply(
        null,
        arguments
      );
    }),
    He = (L._emscripten_bind_Mesh_Mesh_0 = function() {
      return L.asm._emscripten_bind_Mesh_Mesh_0.apply(null, arguments);
    }),
    We = (L._emscripten_bind_Mesh___destroy___0 = function() {
    ...
    qe = (L._emscripten_bind_Mesh_num_attributes_0 = function() {
      return L.asm._emscripten_bind_Mesh_num_attributes_0.apply(
        null,
        arguments
      );
    }),
    Ye = (L._emscripten_bind_Mesh_num_faces_0 = function() {
      return L.asm._emscripten_bind_Mesh_num_faces_0.apply(null, arguments);
    }),
    Xe = (L._emscripten_bind_Mesh_num_points_0 = function() {
      return L.asm._emscripten_bind_Mesh_num_points_0.apply(null, arguments);
    }),
    Ke = (L._emscripten_bind_MetadataQuerier_GetDoubleEntry_2 = function() {
      return L.asm._emscripten_bind_MetadataQuerier_GetDoubleEntry_2.apply(
        null,
        arguments
      );
    }),
    Ze = (L._emscripten_bind_MetadataQuerier_GetEntryName_2 = function() {
      return L.asm._emscripten_bind_MetadataQuerier_GetEntryName_2.apply(
        null,
        arguments
      );
    }),
    Je = (L._emscripten_bind_MetadataQuerier_GetIntEntry_2 = function() {
      return L.asm._emscripten_bind_MetadataQuerier_GetIntEntry_2.apply(
        null,
        arguments
      );
    }),
    tr = (L._emscripten_bind_MetadataQuerier_GetStringEntry_2 = function() {
      return L.asm._emscripten_bind_MetadataQuerier_GetStringEntry_2.apply(
        null,
        arguments
      );
    }),
    er = (L._emscripten_bind_MetadataQuerier_HasDoubleEntry_2 = function() {
      return L.asm._emscripten_bind_MetadataQuerier_HasDoubleEntry_2.apply(
        null,
        arguments
      );
    }),
    rr = (L._emscripten_bind_MetadataQuerier_HasEntry_2 = function() {
      return L.asm._emscripten_bind_MetadataQuerier_HasEntry_2.apply(
        null,
        arguments
      );
    }),
    nr = (L._emscripten_bind_MetadataQuerier_HasIntEntry_2 = function() {
      return L.asm._emscripten_bind_MetadataQuerier_HasIntEntry_2.apply(
        null,
        arguments
      );
    }),
    or = (L._emscripten_bind_MetadataQuerier_HasStringEntry_2 = function() {
      return L.asm._emscripten_bind_MetadataQuerier_HasStringEntry_2.apply(
        null,
        arguments
      );
    }),
    ir = (L._emscripten_bind_MetadataQuerier_MetadataQuerier_0 = function() {
      return L.asm._emscripten_bind_MetadataQuerier_MetadataQuerier_0.apply(
        null,
        arguments
      );
    }),
    _r = (L._emscripten_bind_MetadataQuerier_NumEntries_1 = function() {
      return L.asm._emscripten_bind_MetadataQuerier_NumEntries_1.apply(
        null,
        arguments
      );
    }),
    pr = (L._emscripten_bind_MetadataQuerier___destroy___0 = function() {
      return L.asm._emscripten_bind_MetadataQuerier___destroy___0.apply(
        null,
        arguments
      );
    }),
    ar = (L._emscripten_bind_Metadata_Metadata_0 = function() {
    ...
    ur = (L._emscripten_bind_Metadata___destroy___0 = function() {
      return L.asm._emscripten_bind_Metadata___destroy___0.apply(
        null,
        arguments
      );
    }),
    cr = (L._emscripten_bind_PointAttribute_GetAttributeTransformData_0 = function() {
      return L.asm._emscripten_bind_PointAttribute_GetAttributeTransformData_0.apply(
        null,
        arguments
      );
    }),
    sr = (L._emscripten_bind_PointAttribute_PointAttribute_0 = function() {
      return L.asm._emscripten_bind_PointAttribute_PointAttribute_0.apply(
        null,
        arguments
      );
    }),
    lr = (L._emscripten_bind_PointAttribute___destroy___0 = function() {
      return L.asm._emscripten_bind_PointAttribute___destroy___0.apply(
        null,
        arguments
      );
    }),
    yr = (L._emscripten_bind_PointAttribute_attribute_type_0 = function() {
      return L.asm._emscripten_bind_PointAttribute_attribute_type_0.apply(
        null,
        arguments
      );
    }),
    fr = (L._emscripten_bind_PointAttribute_byte_offset_0 = function() {
      return L.asm._emscripten_bind_PointAttribute_byte_offset_0.apply(
        null,
        arguments
      );
    }),
    mr = (L._emscripten_bind_PointAttribute_byte_stride_0 = function() {
      return L.asm._emscripten_bind_PointAttribute_byte_stride_0.apply(
        null,
        arguments
      );
    }),
    dr = (L._emscripten_bind_PointAttribute_data_type_0 = function() {
      return L.asm._emscripten_bind_PointAttribute_data_type_0.apply(
        null,
        arguments
      );
    }),
    br = (L._emscripten_bind_PointAttribute_normalized_0 = function() {
      return L.asm._emscripten_bind_PointAttribute_normalized_0.apply(
        null,
        arguments
      );
    }),
    hr = (L._emscripten_bind_PointAttribute_num_components_0 = function() {
      return L.asm._emscripten_bind_PointAttribute_num_components_0.apply(
        null,
        arguments
      );
    }),
    Ar = (L._emscripten_bind_PointAttribute_size_0 = function() {
      return L.asm._emscripten_bind_PointAttribute_size_0.apply(
        null,
        arguments
      );
    }),
    Tr = (L._emscripten_bind_PointAttribute_unique_id_0 = function() {
      return L.asm._emscripten_bind_PointAttribute_unique_id_0.apply(
        null,
        arguments
      );
    }),
    Ir = (L._emscripten_bind_PointCloud_PointCloud_0 = function() {
      return L.asm._emscripten_bind_PointCloud_PointCloud_0.apply(
        null,
        arguments
      );
    }),
    vr = (L._emscripten_bind_PointCloud___destroy___0 = function() {
      return L.asm._emscripten_bind_PointCloud___destroy___0.apply(
        null,
        arguments
      );
    }),
    Er = (L._emscripten_bind_PointCloud_num_attributes_0 = function() {
      return L.asm._emscripten_bind_PointCloud_num_attributes_0.apply(
        null,
        arguments
      );
    }),
    Dr = (L._emscripten_bind_PointCloud_num_points_0 = function() {
      return L.asm._emscripten_bind_PointCloud_num_points_0.apply(
        null,
        arguments
      );
    }),
    jr = (L._emscripten_bind_Status___destroy___0 = function() {
      return L.asm._emscripten_bind_Status___destroy___0.apply(null, arguments);
    }),
    gr = (L._emscripten_bind_Status_code_0 = function() {
      return L.asm._emscripten_bind_Status_code_0.apply(null, arguments);
    }),
    Sr = (L._emscripten_bind_Status_error_msg_0 = function() {
      return L.asm._emscripten_bind_Status_error_msg_0.apply(null, arguments);
    }),
    Rr = (L._emscripten_bind_Status_ok_0 = function() {
      return L.asm._emscripten_bind_Status_ok_0.apply(null, arguments);
    }),
    Gr = (L._emscripten_bind_VoidPtr___destroy___0 = function() {
      return L.asm._emscripten_bind_VoidPtr___destroy___0.apply(
        null,
        arguments
      );
    }),
    Mr = (L._emscripten_enum_draco_AttributeTransformType_ATTRIBUTE_INVALID_TRANSFORM = function() {
      return L.asm._emscripten_enum_draco_AttributeTransformType_ATTRIBUTE_INVALID_TRANSFORM.apply(
        null,
        arguments
      );
    }),
    Or = (L._emscripten_enum_draco_AttributeTransformType_ATTRIBUTE_NO_TRANSFORM = function() {
      return L.asm._emscripten_enum_draco_AttributeTransformType_ATTRIBUTE_NO_TRANSFORM.apply(
        null,
        arguments
      );
    }),
    wr = (L._emscripten_enum_draco_AttributeTransformType_ATTRIBUTE_OCTAHEDRON_TRANSFORM = function() {
      return L.asm._emscripten_enum_draco_AttributeTransformType_ATTRIBUTE_OCTAHEDRON_TRANSFORM.apply(
        null,
        arguments
      );
    }),
    Pr = (L._emscripten_enum_draco_AttributeTransformType_ATTRIBUTE_QUANTIZATION_TRANSFORM = function() {
      return L.asm._emscripten_enum_draco_AttributeTransformType_ATTRIBUTE_QUANTIZATION_TRANSFORM.apply(
        null,
        arguments
      );
    }),
    Cr = (L._emscripten_enum_draco_EncodedGeometryType_INVALID_GEOMETRY_TYPE = function() {
      return L.asm._emscripten_enum_draco_EncodedGeometryType_INVALID_GEOMETRY_TYPE.apply(
        null,
        arguments
      );
    }),
    Nr = (L._emscripten_enum_draco_EncodedGeometryType_POINT_CLOUD = function() {
      return L.asm._emscripten_enum_draco_EncodedGeometryType_POINT_CLOUD.apply(
        null,
        arguments
      );
    }),
    Fr = (L._emscripten_enum_draco_EncodedGeometryType_TRIANGULAR_MESH = function() {
      return L.asm._emscripten_enum_draco_EncodedGeometryType_TRIANGULAR_MESH.apply(
        null,
        arguments
      );
    }),
    Ur = (L._emscripten_enum_draco_GeometryAttribute_Type_COLOR = function() {
      return L.asm._emscripten_enum_draco_GeometryAttribute_Type_COLOR.apply(
        null,
        arguments
      );
    }),
    Br = (L._emscripten_enum_draco_GeometryAttribute_Type_GENERIC = function() {
      return L.asm._emscripten_enum_draco_GeometryAttribute_Type_GENERIC.apply(
        null,
        arguments
      );
    }),
    zr = (L._emscripten_enum_draco_GeometryAttribute_Type_INVALID = function() {
      return L.asm._emscripten_enum_draco_GeometryAttribute_Type_INVALID.apply(
        null,
        arguments
      );
    }),
    Lr = (L._emscripten_enum_draco_GeometryAttribute_Type_NORMAL = function() {
      return L.asm._emscripten_enum_draco_GeometryAttribute_Type_NORMAL.apply(
        null,
        arguments
      );
    }),
    xr = (L._emscripten_enum_draco_GeometryAttribute_Type_POSITION = function() {
      return L.asm._emscripten_enum_draco_GeometryAttribute_Type_POSITION.apply(
        null,
        arguments
      );
    }),
    kr = (L._emscripten_enum_draco_GeometryAttribute_Type_TEX_COORD = function() {
      return L.asm._emscripten_enum_draco_GeometryAttribute_Type_TEX_COORD.apply(
        null,
        arguments
      );
    }),
    Vr = (L._emscripten_enum_draco_StatusCode_ERROR = function() {
      return L.asm._emscripten_enum_draco_StatusCode_ERROR.apply(
        null,
        arguments
      );
    }),
    $r = (L._emscripten_enum_draco_StatusCode_INVALID_PARAMETER = function() {
      return L.asm._emscripten_enum_draco_StatusCode_INVALID_PARAMETER.apply(
        null,
        arguments
      );
    }),
    Qr = (L._emscripten_enum_draco_StatusCode_IO_ERROR = function() {
      return L.asm._emscripten_enum_draco_StatusCode_IO_ERROR.apply(
        null,
        arguments
      );
    }),
    Hr = (L._emscripten_enum_draco_StatusCode_OK = function() {
      return L.asm._emscripten_enum_draco_StatusCode_OK.apply(null, arguments);
    }),
    Wr = (L._emscripten_enum_draco_StatusCode_UNKNOWN_VERSION = function() {
      return L.asm._emscripten_enum_draco_StatusCode_UNKNOWN_VERSION.apply(
        null,
        arguments
      );
    }),
    qr = (L._emscripten_enum_draco_StatusCode_UNSUPPORTED_VERSION = function() {
      return L.asm._emscripten_enum_draco_StatusCode_UNSUPPORTED_VERSION.apply(
        null,
        arguments
      );
    }),
    Yr = (L._emscripten_replace_memory = function() {
  ...
  if (
    ...
    (L.run = f),
    (L.exit = function(t, e) {
      (e && L.noExitRuntime && 0 === t) ||
        (!L.noExitRuntime &&
          ((pt = !0), (nt = void 0), p(ht), L.onExit) &&
          L.onExit(t),
        Y && process.exit(t),
        L.quit(t, new y(t)));
    }),
  ...
  var Zr = {
    ...
    prepare: function() {
      if (Zr.needed) {
        for (var t = 0; t < Zr.temps.length; t++) L._free(Zr.temps[t]);
        (Zr.temps.length = 0),
          L._free(Zr.buffer),
          (Zr.buffer = 0),
          (Zr.size += Zr.needed),
      ...
      Zr.buffer ||
        ((Zr.size += 128), (Zr.buffer = L._malloc(Zr.size)), r(Zr.buffer)),
        (Zr.pos = 0);
    },
    alloc: function(t, e) {
      return (
        ...
        Zr.pos + t >= Zr.size
          ? (r(0 < t), (Zr.needed += t), (e = L._malloc(t)), Zr.temps.push(e))
          : ((e = Zr.buffer + Zr.pos), (Zr.pos += t)),
        e
      );
    },
    copy: function(t, e, r) {
  ...
  return (
    ...
    (T.__cache__ = {}),
    (L.Status = T),
    (T.prototype.code = T.prototype.code = function() {
      return gr(this.ptr);
    }),
    ...
    (I.__cache__ = {}),
    (L.DracoUInt16Array = I),
    (I.prototype.GetValue = I.prototype.GetValue = function(t) {
      var e = this.ptr;
    ...
    (E.__cache__ = {}),
    (L.DracoUInt8Array = E),
    (E.prototype.GetValue = E.prototype.GetValue = function(t) {
      var e = this.ptr;
    ...
    (D.prototype.__class__ = D),
    (D.__cache__ = {}),
    (L.DracoUInt32Array = D),
    (D.prototype.GetValue = D.prototype.GetValue = function(t) {
      var e = this.ptr;
    ...
    (j.__cache__ = {}),
    (L.AttributeOctahedronTransform = j),
    (j.prototype.InitFromAttribute = j.prototype.InitFromAttribute = function(
      t
    ) {
      var e = this.ptr;
      return t && "object" == typeof t && (t = t.ptr), !!Ot(e, t);
    }),
    ...
    (g.prototype.GetAttributeTransformData = g.prototype.GetAttributeTransformData = function() {
      return h(cr(this.ptr), S);
    }),
    (g.prototype.attribute_type = g.prototype.attribute_type = function() {
      return yr(this.ptr);
    }),
    (g.prototype.data_type = g.prototype.data_type = function() {
      return dr(this.ptr);
    }),
    (g.prototype.num_components = g.prototype.num_components = function() {
      return hr(this.ptr);
    }),
    (g.prototype.normalized = g.prototype.normalized = function() {
      return !!br(this.ptr);
    }),
    (g.prototype.byte_stride = g.prototype.byte_stride = function() {
      return mr(this.ptr);
    }),
    (g.prototype.byte_offset = g.prototype.byte_offset = function() {
      return fr(this.ptr);
    }),
    (g.prototype.unique_id = g.prototype.unique_id = function() {
      return Tr(this.ptr);
    }),
    ...
    (R.__cache__ = {}),
    (L.AttributeQuantizationTransform = R),
    (R.prototype.InitFromAttribute = R.prototype.InitFromAttribute = function(
      t
    ) {
      var e = this.ptr;
    ...
    (R.prototype.min_value = R.prototype.min_value = function(t) {
      var e = this.ptr;
      return t && "object" == typeof t && (t = t.ptr), Ut(e, t);
    }),
    (R.prototype.range = R.prototype.range = function() {
      return zt(this.ptr);
    }),
    ...
    (G.__cache__ = {}),
    (L.DracoInt8Array = G),
    (G.prototype.GetValue = G.prototype.GetValue = function(t) {
      var e = this.ptr;
    ...
    (M.__cache__ = {}),
    (L.MetadataQuerier = M),
    (M.prototype.HasEntry = M.prototype.HasEntry = function(t, e) {
      var r = this.ptr;
      return (
        Zr.prepare(),
        t && "object" == typeof t && (t = t.ptr),
        (e = e && "object" == typeof e ? e.ptr : A(e)),
        !!rr(r, t, e)
      );
    }),
    ...
    (O.__cache__ = {}),
    (L.DracoInt16Array = O),
    (O.prototype.GetValue = O.prototype.GetValue = function(t) {
      var e = this.ptr;
    ...
    (w.__cache__ = {}),
    (L.DracoFloat32Array = w),
    (w.prototype.GetValue = w.prototype.GetValue = function(t) {
      var e = this.ptr;
    ...
    (C.__cache__ = {}),
    (L.DecoderBuffer = C),
    (C.prototype.Init = C.prototype.Init = function(t, e) {
      var r = this.ptr;
      if ((Zr.prepare(), "object" == typeof t && "object" == typeof t)) {
        var n = Zr.alloc(t, K);
        Zr.copy(t, K, n), (t = n);
      }
    ...
    (N.__cache__ = {}),
    (L.Decoder = N),
    (N.prototype.GetEncodedGeometryType = N.prototype.GetEncodedGeometryType = function(
      t
    ) {
      var e = this.ptr;
      return t && "object" == typeof t && (t = t.ptr), ce(e, t);
    }),
    (N.prototype.DecodeBufferToPointCloud = N.prototype.DecodeBufferToPointCloud = function(
      t,
      e
    ) {
      var r = this.ptr;
    ...
    (N.prototype.DecodeBufferToMesh = N.prototype.DecodeBufferToMesh = function(
      t,
      e
    ) {
      var r = this.ptr;
    ...
    (N.prototype.GetAttributeIdByName = N.prototype.GetAttributeIdByName = function(
      t,
      e
    ) {
      var r = this.ptr;
    ...
    (N.prototype.GetAttributeIdByMetadataEntry = N.prototype.GetAttributeIdByMetadataEntry = function(
      t,
      e,
      r
    ) {
    ...
    (N.prototype.GetAttributeByUniqueId = N.prototype.GetAttributeByUniqueId = function(
      t,
      e
    ) {
      var r = this.ptr;
    ...
    (N.prototype.GetAttributeMetadata = N.prototype.GetAttributeMetadata = function(
      t,
      e
    ) {
      var r = this.ptr;
    ...
    (N.prototype.GetFaceFromMesh = N.prototype.GetFaceFromMesh = function(
      t,
      e,
      r
    ) {
    ...
    (N.prototype.GetTriangleStripsFromMesh = N.prototype.GetTriangleStripsFromMesh = function(
      t,
      e
    ) {
      var r = this.ptr;
    ...
    (N.prototype.GetAttributeFloat = N.prototype.GetAttributeFloat = function(
      t,
      e,
      r
    ) {
    ...
    (N.prototype.GetAttributeFloatForAllPoints = N.prototype.GetAttributeFloatForAllPoints = function(
      t,
      e,
      r
    ) {
    ...
    (N.prototype.GetAttributeIntForAllPoints = N.prototype.GetAttributeIntForAllPoints = function(
      t,
      e,
      r
    ) {
    ...
    (N.prototype.GetAttributeInt8ForAllPoints = N.prototype.GetAttributeInt8ForAllPoints = function(
      t,
      e,
      r
    ) {
    ...
    (N.prototype.GetAttributeUInt8ForAllPoints = N.prototype.GetAttributeUInt8ForAllPoints = function(
      t,
      e,
      r
    ) {
    ...
    (N.prototype.GetAttributeInt16ForAllPoints = N.prototype.GetAttributeInt16ForAllPoints = function(
      t,
      e,
      r
    ) {
    ...
    (N.prototype.GetAttributeUInt16ForAllPoints = N.prototype.GetAttributeUInt16ForAllPoints = function(
      t,
      e,
      r
    ) {
    ...
    (N.prototype.GetAttributeInt32ForAllPoints = N.prototype.GetAttributeInt32ForAllPoints = function(
      t,
      e,
      r
    ) {
    ...
    (N.prototype.GetAttributeUInt32ForAllPoints = N.prototype.GetAttributeUInt32ForAllPoints = function(
      t,
      e,
      r
    ) {
    ...
    (N.prototype.SkipAttributeTransform = N.prototype.SkipAttributeTransform = function(
      t
    ) {
      var e = this.ptr;
    ...
    (F.__cache__ = {}),
    (L.Mesh = F),
    (F.prototype.num_faces = F.prototype.num_faces = function() {
      return Ye(this.ptr);
    }),
    ...
    (B.__cache__ = {}),
    (L.DracoInt32Array = B),
    (B.prototype.GetValue = B.prototype.GetValue = function(t) {
      var e = this.ptr;
    ...
    (function() {
      function t() {
        (L.OK = Hr()),
          (L.ERROR = Vr()),
          (L.IO_ERROR = Qr()),
          (L.INVALID_PARAMETER = $r()),
          (L.UNSUPPORTED_VERSION = qr()),
          (L.UNKNOWN_VERSION = Wr()),
          (L.INVALID_GEOMETRY_TYPE = Cr()),
          (L.POINT_CLOUD = Nr()),
          (L.TRIANGULAR_MESH = Fr()),
          (L.ATTRIBUTE_INVALID_TRANSFORM = Mr()),
          (L.ATTRIBUTE_NO_TRANSFORM = Or()),
          (L.ATTRIBUTE_QUANTIZATION_TRANSFORM = Pr()),
          (L.ATTRIBUTE_OCTAHEDRON_TRANSFORM = wr()),
          (L.INVALID = zr()),
          (L.POSITION = xr()),
          (L.NORMAL = Lr()),
          (L.COLOR = Ur()),
